...
from dataset.random_circuit import random_circuit, su4_circuit
from common.circuit_preprocessing import circuit_preprocessing_matrix

from match_pattern_parallel import GenPulse, MatchPattern
...
class Experiment:
    ...
    def _load_matrix(self, random=False):
        """
